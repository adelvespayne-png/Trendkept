...
from vesper.core.brain import Brain, is_health
from vesper.core.redflag import check, SymptomLog
from vesper.core.triggers import TriggerEngine, configure_health
from vesper.core.world_state import WorldState
from vesper.sensors.health import HealthFeed, Baseline
...
def main():
    ...
    from vesper.core.brain import is_dangerous
