"""Exertion and recovery — a wearable's numbers, compared against your own.
    ...
    python -m vesper.sensors.health            # fetch once and show the read
    python -m vesper.sensors.health --history  # the baseline it has built
...
LOG = logging.getLogger("vesper.health")
