"""Smart home — optional Home Assistant REST client.
    ...
    python -m jarvis.sensors.home_assistant     # prints your entities
...
failure — so the rest of Jarvis neither knows nor cares whether you own a
single smart plug.
...
def main(argv=None) -> int:
    ...
    print("\n(* = Jarvis is allowed to switch it)")
    return 0
