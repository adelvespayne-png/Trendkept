#!/usr/bin/env python3
"""Trendkept — a disciplined trend-following trading bot, in a single file.
...
USAGE
  ...
  python3 trendkept_bot.py backtest mydata.csv --account 1000 --risk 0.02 -v
  python3 trendkept_bot.py scan     mydata.csv

  # Live data, free, no API key (Stooq -> Yahoo)
  python3 trendkept_bot.py backtest --symbol AAPL --account 1000 -v
  python3 trendkept_bot.py fetch    AAPL --out aapl.csv

  # Alpaca paper trading (free keys from alpaca.markets):
  export APCA_API_KEY_ID=...        # Windows PowerShell: $env:APCA_API_KEY_ID="..."
  export APCA_API_SECRET_KEY=...
  python3 trendkept_bot.py account
  python3 trendkept_bot.py trade  AAPL --risk 0.01 --confirm   # paper, with attached stop
  python3 trendkept_bot.py manage --confirm                    # run daily: trail / exit
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="trendkept_bot", description="Disciplined trend-following trading bot.")
