"""Trendrail Pro financial model — honest edition.
...
def render(md: bool = False) -> str:
    parts: List[str] = []
    if md:
        parts.append("# Trendrail Pro — financial projections\n")
        ...
        parts.append("Trendrail Pro — financial projections (honest edition)")
